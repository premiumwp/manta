...
<form role="search" method="get"<?php manta_attr( 'search-form' ); ?> action="<?php echo esc_url( home_url( '/' ) ) ?>">
	...
	<button type="submit" class="search-submit"><?php manta_icon( array( 'icon' => 'search' ) ); ?><span class="screen-reader-text"><?php echo _x( 'Search', 'submit button', 'manta' ); ?></span></button>
</form>
