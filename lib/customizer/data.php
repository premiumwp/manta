	...
	public static function get_theme_controls() {
		...
		$manta_controls = apply_filters(
			'manta_theme_controls', array(
				...
				array(
					'label'         => esc_html__( 'Change overall site width', 'manta' ),
					'section'       => 'manta_dimension_section',
					'settings'      => 'manta_change_site_width',
					'type'          => 'checkbox',
				),
				array(
					...
					'description'   => esc_html__( 'Change overall site width for laptops and desktops. Minimum allowed site width is 960px. ', 'manta' ),
					'type'          => 'number',
					'input_attrs'   => array( 'step' => 2, 'min' => 960 ),
					'active_callback' => array( 'Manta_Active_Callback', 'is_change_site_width' ),
				),
				array(
					'label'         => esc_html__( 'Change primary sidebar sidebar width', 'manta' ),
					'section'       => 'manta_dimension_section',
					'settings'      => 'manta_change_primary_sidebar_width',
					'type'          => 'checkbox',
				),
				array(
					...
					'description'   => esc_html__( 'Change primary sidebar width for laptops and desktops. Minimum allowed sidebar width is 300px.', 'manta' ),
					'type'          => 'number',
					'input_attrs'   => array( 'step' => 2, 'min' => 300 ),
					'active_callback' => array( 'Manta_Active_Callback', 'is_change_primary_sidebar_width' ),
				),
				array(
					'label'         => esc_html__( 'Change secondary sidebar sidebar width', 'manta' ),
					'section'       => 'manta_dimension_section',
					'settings'      => 'manta_change_secondary_sidebar_width',
					'type'          => 'checkbox',
				),
				array(
					...
					'description'   => esc_html__( 'Change secondary sidebar width for laptops and desktops. Minimum allowed site width is 180px.', 'manta' ),
					'type'          => 'number',
					'input_attrs'   => array( 'step' => 2, 'min' => 180 ),
					'active_callback' => array( 'Manta_Active_Callback', 'is_change_secondary_sidebar_width' ),
				),
				array(
