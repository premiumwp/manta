	...
	public static function get_theme_controls() {
		...
		$manta_controls = apply_filters(
			'manta_theme_controls', array(
				...
				array(
					'label'         => esc_html__( 'Overall site width (in px)', 'manta' ),
					'section'       => 'manta_dimension_section',
				...
				array(
					'label'         => esc_html__( 'Change primary sidebar width', 'manta' ),
					'section'       => 'manta_dimension_section',
					'settings'      => 'manta_change_primary_sidebar_width',
					'type'          => 'checkbox',
				),
				array(
					'label'         => esc_html__( 'Primary sidebar width (in px)', 'manta' ),
					'section'       => 'manta_dimension_section',
				...
				array(
					'label'         => esc_html__( 'Change secondary sidebar width', 'manta' ),
					'section'       => 'manta_dimension_section',
					'settings'      => 'manta_change_secondary_sidebar_width',
					'type'          => 'checkbox',
				),
				array(
					'label'         => esc_html__( 'Secondary sidebar width (in px)', 'manta' ),
					'section'       => 'manta_dimension_section',
