 ...
 * }
 */
function manta_svg( $args = array() ) {
	echo manta_get_svg( $args );
}
 ...
 */
function manta_get_svg( $args = array() ) {
	...
	/*
	 * Manta doesn't use the SVG title or description attributes; non-decorative icons are described with .screen-reader-text.
	 *
 ...
 *
 * Even though stroke and fill css properties can be used without any issues,
 * however, it will show error in W3C css validation. Inlining this css to keep
 * main style.css file clean.
 *
 * @since 1.0.0
 *
